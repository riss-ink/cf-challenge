...
const navigation = [
    ...
    {name: 'Polls', href: 'polls.index', icon: ChartBarIcon, current: false},
    {name: 'Create Poll', href: 'polls.create', icon: PlusIcon, current: false},
    {name: 'User Interface', href: 'interface.edit', icon: UserIcon, current: false},
